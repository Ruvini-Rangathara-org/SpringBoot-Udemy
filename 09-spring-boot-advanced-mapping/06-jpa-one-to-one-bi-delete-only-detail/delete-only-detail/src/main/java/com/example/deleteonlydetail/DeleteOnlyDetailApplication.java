package com.example.deleteonlydetail;

import com.example.deleteonlydetail.dao.AppDAO;
...
public class DeleteOnlyDetailApplication {

	public static void main(String[] args) {
		SpringApplication.run(DeleteOnlyDetailApplication.class, args);
	}
