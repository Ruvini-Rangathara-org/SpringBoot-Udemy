package com.example.manytomanyfind;

import com.example.manytomanyfind.dao.AppDAO;
import com.example.manytomanyfind.entity.Course;
import com.example.manytomanyfind.entity.Review;
...
public class ManyToManyFindApplication {

	public static void main(String[] args) {
		SpringApplication.run(ManyToManyFindApplication.class, args);
	}
	@Bean
