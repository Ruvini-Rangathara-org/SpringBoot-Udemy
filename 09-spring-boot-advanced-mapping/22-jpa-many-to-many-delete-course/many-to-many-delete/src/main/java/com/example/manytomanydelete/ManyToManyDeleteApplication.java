package com.example.manytomanydelete;

import com.example.manytomanydelete.dao.AppDAO;
import com.example.manytomanydelete.entity.Course;
import com.example.manytomanydelete.entity.Review;
...
public class ManyToManyDeleteApplication {

	public static void main(String[] args) {
		SpringApplication.run(ManyToManyDeleteApplication.class, args);
	}
	@Bean
